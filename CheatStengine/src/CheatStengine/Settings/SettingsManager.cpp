...
void SettingsManager::DrawSettingsPopup(const std::string& name)
{
...
void SettingsManager::Restore() const
{
...
void SettingsManager::Apply() const
{
    for (const SettingsCategory& category : m_Categories) {
        category.Apply();
    }
...
bool SettingsManager::HasValueChanged() const
{
    for (const SettingsCategory& category : m_Categories) {
...
void SettingsManager::DrawCategoryList() const
{
